...
exports.BrandsModule = BrandsModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: brands_schema_1.Brand.name, schema: brands_schema_1.BrandSchema }])],
        providers: [brands_resolver_1.BrandsResolver, brands_service_1.BrandsService],
    })
], BrandsModule);
